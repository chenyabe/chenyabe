...
Autodig.Text = "自动采集（无用）"
Autodig.TextColor3 = Color3.new(1, 1, 1)
Autodig.TextSize = 14

Autobuffitem.Name = "自动buff"
...
DarkCyberSynapshitGUI.Name = "[DarkC]汉化GUI"
...
for c=1,10 do wait(.3)
      Loadingtext.Text = "正在加载中"..string.rep('.',repss%3+1)
      repss = repss + 1
end
...
for d=1,10 do wait(.3)
      Loadingtext.Text = "正在加载UI"..string.rep('.',repss%3+1)
      repss = repss + 1
end
 
if game.PlaceId == 1537690962 or game.PlaceId == 4079902982 then
Loadingtext.Text = "UI加载成功"
if syn then
...
if game.Players.LocalPlayer.UserId == truonghopdacbiet or game.Players.LocalPlayer.Name == truonghopdacbiet2 then
    if act6 == true or act5 == true or afksnail == true or killvici == true or Sparkles == true or tornado
	 == true or dispenser == true or killtunell == true or killcoconut == true or item == true or tpwindy == true or Windy == true then
